...
namespace Leblanc
{
 ...
 public static void Combo()
	...
	if (W.IsReady())
	{
            ...
            var minions = MinionManager.GetMinions(W.Range+200).Select(m => m.ServerPosition.To2D()).ToList();
            var minionPrediction = MinionManager.GetBestCircularFarmLocation(minions, 200, W.Range);
